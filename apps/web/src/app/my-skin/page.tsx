...
export default function MySkin(){
 ...
 async function feedback(value:string){setBusy(value);setMessage('');setError('');try{const result=await hub('/profile/feedback',{feedback:value});setMessage(result.text);}catch(e){setError((e as Error).message);}finally{setBusy('');}}
